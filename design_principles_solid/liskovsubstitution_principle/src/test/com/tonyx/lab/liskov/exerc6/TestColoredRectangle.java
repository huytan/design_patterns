package test.com.tonyx.lab.liskov.exerc6;

import junit.framework.TestCase;
import com.tonyx.lab.liskov.exerc6.*;
...
public class TestColoredRectangle extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        coloredPositiveTridimentionalRectangleDefault = new ColoredPositiveTridimentionalRectangle(1.1,1.1);
        coloredPositiveTridimentionalRectangleNoDefault = new ColoredPositiveTridimentionalRectangle(1.1,1.1,1.1,ColoredPositiveRectangle.NERO);

        super.setUp();
    }

    public static void testUtil() throws Exception
    {
        assertTrue(Utils.isHerarchicallySubClass(ColoredPositiveRectangle.class,RectangleImpl.class));
    }
